...
const MyAccount = () => {
    return (
        <>
            <Box className="pl-100 pr-100 pb-100" sx={{ flexGrow: 1, paddingTop: '80px' }}>
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', border: '1px solid var(--stroke-card)', borderRadius: '16px', padding: '40px' }}>
                    <Box>
                        ...
                        <Box>
                            <Grid container spacing={4}>
                                <Grid item xs={12} md={6}>
                                    ...
                                    <CustomTextField label={'Work name'} placeholder={'Enter the name of your work'} borderRadius={'8px'} bgColor={'#FFFFFF'} paddingLeft={'8px'} marginBottom={'24px'} />
                                    <CustomTextField label={'Work URL'} placeholder={'Paste the URL of your work'} borderRadius={'8px'} bgColor={'#FFFFFF'} paddingLeft={'8px'} marginBottom={'24px'} />
                                    <CustomSelectField />
                                </Grid>
                                <Grid item xs={12} md={6}>
                                    ...
                                    <CustomTextField label={''} placeholder={'Enter the URL of the page where the link is included'} borderRadius={'8px'} bgColor={'#FFFFFF'} paddingLeft={'8px'} marginBottom={'30px'} />
